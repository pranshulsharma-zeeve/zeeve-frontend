...
const NetworkNodeStatus = ({
  ...
  if (type === "badge") {
    switch (status?.toLowerCase()) {
      ...
      case "provisioning":
        return (
          <div className="mr-8 rounded-md bg-brand-primary p-1 text-center text-xs font-bold text-brand-light">
            {disableToolTip ? (
              <div>{statusText ?? status.toUpperCase()}</div>
            ) : (
      ...
      case "failed":
        return (
          <div className="mr-8 rounded-md bg-brand-red p-1 text-center text-xs font-bold text-brand-light">
            {disableToolTip ? (
              <div>{statusText ?? status.toUpperCase()}</div>
            ) : (
      ...
      case "ready":
        return (
          <div className="mr-8 rounded-md bg-brand-green p-1 text-center text-xs font-bold text-brand-light">
            {disableToolTip ? (
              <div>{statusText ?? status.toUpperCase()}</div>
            ) : (
