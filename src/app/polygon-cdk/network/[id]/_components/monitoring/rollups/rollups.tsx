      ...
      <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col gap-2 rounded-lg sm:flex-row sm:items-center sm:gap-3">
          ...
          <KeyValue
            ...
            value={
              dashboard?.data.rollUpAnalysis.totalTransactions
                ? formatNumber(dashboard.data.rollUpAnalysis.totalTransactions, "standard")
                : "NA"
            }
          />
        </div>
        <div className="flex flex-col gap-2 rounded-lg sm:flex-row sm:items-center sm:gap-3">
          ...
          <KeyValue
            ...
            value={dashboard?.data?.counters?.totalContracts || "NA"}
          />
        </div>
        <div className="flex flex-col gap-2 rounded-lg sm:flex-row sm:items-center sm:gap-3">
          <div className="mt-1">
        ...
        <div className="flex flex-col gap-2 rounded-lg p-3 px-0 sm:flex-row sm:items-center sm:gap-3">
          <div className="mt-1">
            <Image
          ...
          <KeyValue
            ...
            className="col-span-1 text-2xl font-semibold lg:col-span-1"
            label="Gas Used"
            value={dashboard?.data?.rollUpAnalysis?.gasUsed?.toFixed(3) || "NA"}
          />
        </div>
        <div className="flex flex-col gap-2 rounded-lg sm:flex-row sm:items-center sm:gap-3">
          <div className="mt-1">
          ...
          <KeyValue
            ...
            labelClassName="text-[#696969]"
            value={
              dashboard?.data.rollUpAnalysis.totalUsers
                ? formatNumber(dashboard.data.rollUpAnalysis.totalUsers, "standard")
                : "NA"
            }
          />
        </div>
