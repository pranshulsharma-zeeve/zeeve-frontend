...
export default function ToolsRollupServices() {
  ...
  return (
    <div className="flex size-full flex-col overflow-hidden rounded-3xl border border-[#E1E1E1] text-black">
      ...
      <div className="grid h-full grid-cols-1 bg-[#F5F5F5] p-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 lg:gap-x-32">
        {serviceEntries.map(([serviceName, items], nodeIndex) => {
          if (serviceName.toLocaleLowerCase() !== "rpc" && serviceName.toLocaleLowerCase() !== "dac") {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    {serviceName.toLocaleLowerCase() === "explorer" && (
                      <Image
                        className="invisible size-0 md:w-16"
