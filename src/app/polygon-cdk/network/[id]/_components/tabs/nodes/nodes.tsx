...
import { CopyButton, Tooltip } from "@zeeve-platform/ui";
...
const Nodes = () => {
  ...
  const listViewColumns: ColumnDef<Node, any>[] = useMemo(
    () => [
      ...
      //       href={`/polygon-cdk/network/${networkId}/nodes/${props.row.original.nodeType}/${props.row.original.id}?network=${networkName}`}
      //     >
      //       View Details
      //     </Link>
      //   ),
