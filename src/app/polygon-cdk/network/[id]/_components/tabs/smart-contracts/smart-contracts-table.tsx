...
const getExplorerURL = (source: string, address?: string, explorerL1Url?: string, explorerL2Url?: string) => {
  const rawEndpoint = source === "L1" ? explorerL1Url : explorerL2Url;
    ...
    <div className="col-span-12 flex flex-col overflow-hidden rounded-lg border border-brand-outline md:col-span-12 lg:col-span-6">
      <div className="mb-1 flex items-center justify-between p-4">
        ...
        <div className="flex gap-2">
          <Tooltip text={"Docs to deploy contract in Polygon CDK"} placement="top-start">
            <IconButton
              colorScheme="primary"
              variant={"ghost"}
              isDisabled={!data}
              ...
              onClick={() => {
                if (data) {
                  window.open("https://docs.zeeve.io/rollups/polygon-cdk-zkrollups/demo-network/deploy-contract");
                }
              }}
            >
