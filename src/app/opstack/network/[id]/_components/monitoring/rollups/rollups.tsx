      ...
      <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col gap-2 rounded-lg sm:flex-row sm:items-center sm:gap-3">
          ...
          <KeyValue
            ...
            value={dashboard?.data.rollUpAnalysis.totalTransactions || "NA"}
          />
        </div>
        <div className="flex flex-col gap-2 rounded-lg sm:flex-row sm:items-center sm:gap-3">
          <div className="mt-1">
          ...
          <KeyValue
            ...
            value={dashboard?.data.rollUpAnalysis.verifiedSmartContracts || "NA"}
          />
        </div>
        <div className="flex flex-col gap-2 rounded-lg p-3 pl-0 sm:flex-row sm:items-center sm:gap-3">
          <div className="mt-1">
            <Image
          ...
          <KeyValue
            ...
            value={
              dashboard?.data.rollUpAnalysis.avgGasPrice
                ? formatNumber(Number(dashboard.data.rollUpAnalysis.avgGasPrice), "standard")
                : "0"
            }
          />
        </div>
        <div className="flex flex-col gap-2 rounded-lg p-0 sm:flex-row sm:items-center sm:gap-3">
          ...
          <KeyValue
            ...
            labelClassName="text-[#696969]"
            value={dashboard?.data.rollUpAnalysis.totalUsers || "NA"}
          />
        </div>
        <div className="flex flex-col gap-2 rounded-lg sm:flex-row sm:items-center sm:gap-3">
          ...
          <KeyValue
            ...
            value={dashboard?.data?.counters.totalAccounts || "NA"}
          />
        </div>
