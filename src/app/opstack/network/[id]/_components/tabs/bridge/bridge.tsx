...
const Bridge = () => {
  ...
  } = useOpStackService().network.bridgeInfo(networkId, "bridge");
      ...
      <div className="col-span-12 flex flex-col rounded-lg border border-brand-outline">
        <div className="p-4">
          ...
          <p className="mt-1 text-sm text-brand-gray">
            The OP Stack comes with a native bridge with UI that allows you to transfer funds between L1, L2 and
