    ...
    <div className={`${className} col-span-12 flex flex-col rounded-2xl border border-[#89BBF54D] lg:flex-row`}>
      ...
      >
        ...
        <div className=" flex flex-col rounded-lg p-3 text-center text-2xl font-semibold">
          <span className="text-2xl font-semibold"># {dashboard?.data?.rollUpStatus?.totalSequencedBatches}</span>
          <label className="mt-1 text-sm font-normal text-[#FFFFFFB2]">Last Sequence No.</label>
          <div className="mt-6">
            <Link
              as={"a"}
              target="_blank"
              rel="noopener noreferrer"
              href={normalized?.rollupMetadata?.l2?.explorerUrl || "#"}
            >
              <Button
