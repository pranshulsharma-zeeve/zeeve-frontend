...
const DemoNetworkInfo = ({ className }: InfoProps) => {
  ...
  const isDemo = Boolean(normalizedId && normalizedId === ZKSYNC_DEMO_SERVICE_ID);
    ...
    >
      ...
      <div className="2xl:flex 2xl:grow 2xl:flex-row 2xl:items-center 2xl:justify-between">
        <div className="text-sm font-medium text-brand-dark">
          Fully functional demo zkSync Hyperchain testnet, available to all users. Deploy a private network via
          <Link href="/zksync/deploy" className="text-brand-primary">
            {" "}
            Deploy Testnet
