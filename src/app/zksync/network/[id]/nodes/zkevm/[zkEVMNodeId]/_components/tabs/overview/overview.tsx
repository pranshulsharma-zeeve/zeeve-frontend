...
const Overview = () => {
  ...
  } = useZkSyncValidiumService().node.info(supernetId, zkEVMNodeId);
  ...
  } = useZkSyncValidiumService().supernet.walletDetails(supernetId, "name", "aggregator");
  ...
  } = useZkSyncValidiumService().supernet.supernetInfo(supernetId);
