...
import { ProtocolPlanCard } from "@/app/manage/nodes/archive/protocols/_components/protocol-plan-card";
...
const ArchiveNodesSubscriptionsPageClient = () => {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (storedServiceURL) {
        ...
        if (storedServiceURL.includes("/manage/nodes/archive")) {
  ...
  } = usePlatformService().node_journey.list("archive");
      ...
      {isProtocolListDataLoading ? (
        ...
        <div className="z-5 relative rounded-2xl">
          ...
          <div className="relative  grid grid-cols-5 gap-3 rounded-2xl border bg-white">
            <div className="col-span-5 max-h-[900px] max-w-[270] overflow-y-auto rounded-l-2xl bg-brand-archive-10 p-3 scrollbar-hide lg:col-span-1 lg:px-3 lg:py-6">
              <div className="sticky top-0 z-10 -mx-3 bg-brand-archive-10 px-3 pb-3 pt-1 lg:mx-0 lg:px-0 lg:pb-4 lg:pt-0">
                <SearchInput
                  autoComplete="off"
...
export default ArchiveNodesSubscriptionsPageClient;
