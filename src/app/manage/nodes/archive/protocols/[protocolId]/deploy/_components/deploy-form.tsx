...
interface ArchiveNodeDeploymentProps {
...
const ArchiveNodeDeploymentForm = ({
  data,
  regionId,
  regionName,
  continentType,
  ...
  const onSubmit = async (formData: NodeDeploymentSchemaType) => {
    const body: NodeDeploymentRequestPayload = {
      general: {
        ...
        nodeType: isFullNode ? "full" : "archive",
      },
      rpc: {
...
export default ArchiveNodeDeploymentForm;
