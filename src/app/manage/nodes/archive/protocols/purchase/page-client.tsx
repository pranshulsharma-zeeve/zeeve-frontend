...
const ArchiveNodePurchasePageClient = () => {
  ...
  const protocolRecords = useMemo(() => protocolListResponse?.data ?? [], [protocolListResponse]);
          ...
          breadcrumb={{
            items: [
              ...
              ...(from !== "smart-node"
                ...
                : []),
              {
                href: withBasePath(`${ROUTES.PLATFORM.PAGE.MANAGE_ARCHIVE_NODES_PROTOCOLS}${withQuery}`),
                label: "Select Plan",
              },
              {
                href: "",
        ...
        <div>
          <Z4Button
            ...
            onClick={() => {
              ...
              router.push(ROUTES.PLATFORM.PAGE.MANAGE_ARCHIVE_NODES_PROTOCOLS);
            }}
          >
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                "https://docs.zeeve.io/archive-nodes/deploy-your-archive-node",
                "_blank",
                "noopener,noreferrer",
              )
            }
...
export default ArchiveNodePurchasePageClient;
