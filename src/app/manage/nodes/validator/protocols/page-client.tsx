...
import { useRouter, useSearchParams } from "next/navigation"; // Added import for useRouter
...
import { ProtocolPlanCard } from "@/app/manage/nodes/validator/protocols/_components/protocol-plan-card";
...
const ValidatorNodesSubscriptionsPageClient = () => {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (storedServiceURL) {
        ...
        if (storedServiceURL.includes("/manage/nodes/validator")) {
          console.log("service url in useEffect---2.0", storedServiceURL);
  ...
  const handleCardFocus = (id: string, name: string) => {
    // --- Step 1: Update the URL with new protocol
      ...
      {/* <Z4Navigation
        ...
        breadcrumb={{
          items: [
            ...
            {
              href: withBasePath(`${ROUTES.PLATFORM.PAGE.MANAGE_VALIDATOR_NODES_PROTOCOLS}`),
              label: "Select Plan",
              isActive: true,
            },
          ],
      ...
      {isProtocolListDataLoading ? (
        ...
        <div className="z-5 relative rounded-2xl">
          ...
          <div className="relative  grid grid-cols-5 gap-3 rounded-2xl border bg-white">
            <div className="col-span-5 max-h-[900px] max-w-[270] overflow-y-auto rounded-l-2xl bg-brand-validator-10 p-3 scrollbar-hide lg:col-span-1 lg:px-3 lg:py-6">
              <div className="sticky top-0 z-10 -mx-3 bg-brand-validator-10 px-3 pb-3 pt-1 lg:mx-0 lg:px-0 lg:pb-4 lg:pt-0">
                <SearchInput
                  autoComplete="off"
            ...
            <div className="col-span-5 pr-3 lg:col-span-4 lg:pr-6">
              ...
              {focusedProtocolCard.id && activeRecord ? (
                <div className="grid grid-cols-4 gap-3 lg:grid-cols-3 lg:gap-6">
                  <div className="col-span-4 flex flex-row items-center gap-3 p-3 lg:col-span-3 lg:p-6">
                    {activeProtocolIcon ? (
                      <Image
                      ...
                      <div className="flex size-8 items-center justify-center rounded-full bg-brand-validator text-sm font-semibold text-white">
...
export default ValidatorNodesSubscriptionsPageClient;
