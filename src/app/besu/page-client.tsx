...
import KeyFeatureCard from "./_components/keyFeatureCard";
...
const keyFeatures: { title: string; content: string }[] = [
  {
    ...
    content: "Unlimited flexibility to deploy and manage your Hyperledger Besu network",
  },
  {
  ...
  },
  {
    ...
    content: "Expert support for migration to your own Hyperledger Besu network infrastructure",
  },
];

const isLoading = false;

const BesuPageClient = () => {
  ...
  return (
    <div className="flex flex-col gap-6 lg:gap-8">
        ...
        heading={
          <div>
            {isLoading ? (
              ...
              <div className="flex flex-row items-center gap-2">Hyperledger Besu</div>
            )}
          </div>
        }
        breadcrumb={{
      ...
      <div className="relative overflow-hidden rounded-[28px] border border-white/50 shadow-[0px_21px_18px_0px_#0000000A]">
        <Image
          src={withBasePath(`/assets/images/besu/bg-banner.svg`)}
          alt="Banner"
      ...
      <div className="flex flex-col gap-5 rounded-[28px] border border-white bg-[#FFFFFF66] p-5 backdrop-blur-sm sm:p-8 lg:p-10">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-stretch">
          <div className="flex w-full shrink-0 flex-col items-center gap-5 rounded-2xl bg-white p-5 text-center shadow-[0px_5px_10px_0px_#00000005] sm:p-6 lg:w-[320px] lg:items-start lg:text-left">
            <div className="flex w-full flex-col gap-4 border-b border-[#E1E1E1] pb-5">
              <div className="flex flex-col items-center gap-3 sm:flex-row sm:items-center lg:items-start">
                <div className="relative size-[64px] shrink-0 overflow-hidden rounded-full">
                  <Image
                    src={withBasePath(`/assets/images/besu/davidPalmer.jpeg`)}
                    alt="Reviewer logo"
                    fill
                ...
                <div className="flex min-w-0 flex-col">
                  <span className="text-lg font-medium text-[#383535]">David Palmer</span>
                  <span className="text-xs leading-5 text-[#4D4D4E]">Co-Founder, Vodafone&apos;s Pairpoint</span>
                </div>
              </div>
              <Image
            ...
            <Image
              src={withBasePath(`/assets/images/besu/vodafone.svg`)}
              alt={`Vodafone Icon`}
          ...
          <div className="flex flex-1 items-center rounded-2xl bg-white/70 p-5 text-sm leading-7 text-[#4D4D4E] shadow-[0px_5px_10px_0px_#00000005] sm:p-6 sm:text-base lg:p-8">
            “Zeeve have delivered consistently to help us fulfil our Economy of Things initiative with a powerful and
            flexible Blockchain Infrastructure as a Service offering. Our teams have greatly appreciated their protocol
            expertise and technical and advisory support. Zeeve’s multi-protocol and multi-cloud flexibility will be a
            key benefit in on-boarding other members in our consortium.”
          </div>
        </div>
      </div>
    </div>
