...
import useArbitrumOrbitService from "@/modules/arbitrum-orbit/services/arbitrum-orbit/use-arbitrum-orbit-service";
...
const IdPageClient = () => {
  ...
  const items = [
    ...
    {
      href: withBasePath(ROUTES.ARBITRUM_ORBIT.PAGE.LIST),
      label: "Arbitrum Orbit",
      as: Link,
      isActive: false,
    },
    {
      href: withBasePath(`${ROUTES.ARBITRUM_ORBIT.PAGE.NETWORK}/${networkId}`),
