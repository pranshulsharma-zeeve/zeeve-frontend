    ...
    >
      <div className="relative mb-2">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
          ...
          />
          <KeyValue
            label="L1 Gas Used for Batch Posting"
            // eth="gwei"
            labelClassName="text-[#696969]"
            valueClassName="border border-[#DC3090] rounded-md p-1 text-[#DC3090]"
            value={
              dashboard?.data.financials.batchGasUsed
                ? formatNumber(dashboard.data.financials.batchGasUsed, "standard")
                : "0"
            }
          />
          <KeyValue
            labelClassName="text-[#696969]"
            label="L1 Gas Price Used for Batch Posting"
            eth="gwei"
            value={
              dashboard?.data.financials.transactionGasPrice
                ? formatDecimals(Number(dashboard.data.financials.transactionGasPrice) / 1e9)
                : "0"
            }
          ...
          <KeyValue
            ...
            value={
              dashboard?.data.financials.blockGasFee
                ? formatNumber(Number(dashboard.data.financials.blockGasFee) / 1e9, "standard")
                : "0"
            }
          />
        </div>
        ...
        <>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <KeyValue
              ...
              eth="greenEth"
              value={formatDecimals(dashboard?.data.financials.validatorBalance) || "0"}
              valueClassName="border border-[#0BB63B] rounded-md p-1 text-[#0BB63B]"
            />
          </div>
