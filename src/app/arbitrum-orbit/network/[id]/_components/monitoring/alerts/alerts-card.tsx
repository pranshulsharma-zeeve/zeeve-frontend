...
const AlertsCard = ({
  ...
  const alertsUrl = isDemoNetwork ? getArbitrumDemoVizionUrl(ROUTES.VISION.API.ALERTS) : alertsUrlConfig;
  ...
  const token = isDemoNetwork ? getArbitrumDemoVizionToken() : (user?.token ?? getCookie("token"));
