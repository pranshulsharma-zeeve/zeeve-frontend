...
export default function ToolsRollupServices() {
  ...
  return (
    <div className="flex h-full min-h-56 w-full flex-col overflow-hidden rounded-3xl border border-[#E1E1E1] text-black">
      ...
      <div className="grid h-full grid-cols-1 bg-[#F5F5F5] p-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 lg:gap-x-32">
        {serviceEntries.map(([serviceName, items], nodeIndex) => {
          if (
            serviceName.toLocaleLowerCase() !== "rpc" &&
            serviceName.toLocaleLowerCase() !== "sequencer" &&
            serviceName.toLocaleLowerCase() !== "dac"
          ) {
            ...
            return (
              <div key={nodeIndex} className="min-w-[200px] bg-[#F5F5F5] p-4">
