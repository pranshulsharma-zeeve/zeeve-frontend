...
export default function DacRollupServices() {
  ...
  return (
    <div className="flex min-h-[350px] flex-col overflow-hidden rounded-3xl border border-[#E1E1E1] text-black shadow-lg">
      ...
      <div
        ...
        style={{
          backgroundImage: "url(/assets/images/protocol/light-bg.svg)",
