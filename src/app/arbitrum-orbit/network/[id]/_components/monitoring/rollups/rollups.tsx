      ...
      <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex flex-col gap-2 rounded-lg p-3 pl-0 sm:flex-row sm:items-center sm:gap-3">
          ...
          <KeyValue
            ...
            label="Gas Used"
            value={
              dashboard?.data.rollUpAnalysis.gasUsed
                ? formatNumber(Number(dashboard.data.rollUpAnalysis.gasUsed) / 1e9, "standard")
                : "0"
            }
          />
        </div>
        ...
        <div className="flex flex-col gap-2 rounded-lg sm:flex-row sm:items-center sm:gap-3">
          ...
          <KeyValue
            ...
            isLoading={isLoading}
            className="col-span-1 text-2xl font-semibold lg:col-span-1"
            label="Transaction Success Count"
            value={dashboard?.data?.rollUpAnalysis.transactionSuccessCount || "NA"}
          />
        </div>
